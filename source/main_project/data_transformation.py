...
class DataTransformation:
    ...
    def get_preprocessor_obj(self):
        try:
            ...
            enc_cols = ['location','gamegenre']
            sc_cols = ['gender','ingamepurchases','gamedifficulty','sessionsperweek','avgsessiondurationminutes','playerlevel','achievementsunlocked']
            ...
            preprocessor = ColumnTransformer([
                ('cat_pipeline',cat_pipeline,enc_cols),
                ('num_pipeline',num_pipeline,sc_cols)
            ])
