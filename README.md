# ONLINE GAMING ENGAGEMENT LEVEL PREDICTION

## Overview
->Pedicting the engagement level of a player in an online game
...
1. **Clone the repository**:
    ```sh
    git clone https://github.com/steve601/onlinegame.git
    cd onlinegame
    ```
...
**Upload Application Code:**
    ...
    Place the code in a suitable directory, e.g., /home/ec2-user/online-gaming
